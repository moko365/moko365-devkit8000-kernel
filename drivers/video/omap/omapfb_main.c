...
static struct video_mode video_modes[] __initdata = {
	...
	},
	{
	...
	},
        {
                ...
                .x_res          = 800,
                .y_res          = 480,
                .hsw            = /*32*/48,	/* hsync_len (4) - 1 */
                .hfp            = /*64*/1,      /* right_margin (4) - 1 */
                .hbp            = /*32*/1,      /* left_margin (40) - 1 */
                .vsw            = /*9*/3,       /* vsync_len (2) - 1 */
                .vfp            = /*18*/12,     /* lower_margin */
                .vbp            = /*18*/25,     /* upper_margin (8) - 1 */
                .pixel_clock    = 36000,
        },
				...
				struct lcd_panel *panel)
{
	...
	if(strcmp(video_mode.name, "4.3inch_LCD") == 0 || strcmp(video_mode.name, "7inch_LCD") == 0){
		fbdev->panel->config	= OMAP_LCDC_PANEL_TFT | OMAP_LCDC_INV_VSYNC | OMAP_LCDC_INV_HSYNC;
	}
